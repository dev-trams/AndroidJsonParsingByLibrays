...
public class LottoDTO {
    ...
    String drwtNo1; //1번 번호
    String drwtNo2; // 2번 번호
    String drwtNo3; // 3번 번호
    String drwtNo4; // 4번 번호
    String drwtNo5; // 5번 번호
    String drwtNo6; // 6번 번호
    String bnusNo; // 보너스 번호
    ...
    public void setdrwNoDate(String drwtNoDate) {
        this.drwNoDate = drwtNoDate;
    }
    ...
    public void setdrwNo(String drwtNo) {
        this.drwNo = drwtNo;
    }
